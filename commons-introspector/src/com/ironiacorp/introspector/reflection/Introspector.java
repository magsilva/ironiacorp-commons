...
{
	private void describe(String lead, Field field)
	{
	...
	private void analyze(String lead, Class<?> clas)
	{

		Set<String> s_processed = new HashSet<String>();
		...
		if (!clas.isPrimitive() && !clas.isInterface() && !name.startsWith("java.lang.")
	...
	public static void main(String[] args) throws Exception
	{
		...
		introspector.analyze("", Introspector.class);
	}
}
