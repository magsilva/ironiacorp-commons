/**
 * Wrapper around the Trinidad/java.util.logging to send the log messages
 * to common logging. After this you just have to call
 * JavaLoggingToCommonLoggingRedirector.activate() once in your code
 * (startup/startup-servlet, something like this).
 *  
 * http://wiki.apache.org/myfaces/Trinidad_and_Common_Logging
 * 
 * Copyright (C) 2007 Markus Doering
 */
